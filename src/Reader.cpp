 ...
 */
void
LoadMatrix(std::string filename, float *pose, Eigen::Matrix4d &Twc)
{
 ...
 */
void
ReadDepth(cv::Mat &depth_img, cv::Mat &depth_gt_img,
 ...
 */
bool
invert_matrix(const float m[16], float invOut[16])
{
    float inv[16], det;
    int i;
    inv[0] = m[5] * m[10] * m[15] -
 ...
 */
void
multiply_matrix(const float m1[16], const float m2[16], float mOut[16])
{
